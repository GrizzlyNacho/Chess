The game of Chess as written by Nathan Lutz
...
Note that the 'bin' directory is included in the repository so that anyone can test the various states of the game just by launching index.html of a given version checkout.